...
void iiiInstances(unsigned x, unsigned y, unsigned w, unsigned h, unsigned clearScreenColor, unsigned clearScreenDepth, float clearScreenDepthValue, const void * pipelineAndSamplersState, unsigned pixelsIndexForUvXy, unsigned pixelsIndexForUvZw);
