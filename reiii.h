...
void iiiTriangles(unsigned id, unsigned x, unsigned y, unsigned w, unsigned h, unsigned clearScreenColor, unsigned clearScreenDepth, float clearScreenDepthValue, unsigned programPreset, const void * pipelineAndSamplersState);
void iiiTriangle(unsigned id,
  ...
  float x2, float y2, float z2, float w2, float r2, float g2, float b2, float a2, float u2x, float v2y, float u2z, float v2w, unsigned pixelsIndexForUvXy, unsigned pixelsIndexForUvZw);
