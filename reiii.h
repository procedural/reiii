...
void iiiPixels(unsigned id, unsigned index, unsigned w, unsigned h, unsigned clearPixels);
void iiiPixel(unsigned id, unsigned x, unsigned y, unsigned char r, unsigned char g, unsigned char b, unsigned char a);
void iiiTriangles(unsigned id, unsigned clearScreen, const void * pipelineAndSamplerState);
void iiiTriangle(unsigned id,
  ...
  float x2, float y2, float z2, float w2, float r2, float g2, float b2, float a2, float u2, float v2, unsigned index);
